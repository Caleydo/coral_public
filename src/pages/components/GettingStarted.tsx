    ...
    <section className="container ordino-getting-started py-5">
      ...
      <ul className="row mx-0 mt-5 p-0 list-unstyled">
        <li className="col col-lg mb-sm-5 mb-lg-0 text-center">
          ...
          <p>
            An initial cohort that contains all items of the selected dataset is created automatically. Creation operations allow users to create new
            sub-cohorts based on different attributes and attribute combinations. Cohorts are refined with the <i>Filter</i> operation, or divided into multiple
            cohorts with the <i>Split</i> operation.
          </p>
        </li>
        <li className="col col-lg mb-sm-5 mb-lg-0 text-center">
          ...
          <p>
            ...
            <i>View</i> operation, and statistically with the <i>Compare</i> operation. Additional operations give access to prevalence information and the data
            of individual items.
          </p>
        </li>
        {/*
