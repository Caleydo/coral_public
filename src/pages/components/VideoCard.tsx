  ...
  return (
    <div style={{ overflow: 'hidden' }} className="card p-2 shadow-sm coral-video-card">
      <div className="card-body">
        ...
        <h5 className="card-title mt-4">
          <i className="me-2 fas fa-database" />
          Datasets
        </h5>
        <p className="card-text">
        ...
        <h5 className="card-title mt-4">
          <i className="me-2 fas fa-book-open" />
          Publications
        </h5>
        <p className="card-text">Coral and its components have been described in the following scientific publications.</p>
        ...
        <p className="card-text">Please cite the first article when using Coral and publishing your results.</p>
        <p className="card-text">
