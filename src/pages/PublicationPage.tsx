      ...
      <div className="shadow-sm card p-2 overflow-hidden">
        <div className="card-body">
          <iframe
            ...
            width="100%"
            height="100%"
            src="https://www.youtube-nocookie.com/embed/vSd3a9J63wQ?autoplay=0"
            frameBorder="0"
          ...
          <p className="card-text">
            A main task in computational cancer analysis is the identification of patient subgroups (i.e., cohorts) based on metadata attributes (patient
            stratification) or genomic markers of response (biomarkers). Coral is a web-based cohort analysis tool that is designed to support this task: Users
            can interactively create and refine cohorts, which can then be compared, characterized, and inspected down to the level of single items. We
            visualize the evolution of cohorts and also provide intuitive access to prevalence information. Coral can be utilized to explore any type of cohort
            and sample set. Here, we focus on the analysis of genomic data from cancer patients and therefore included in the public version data from the AACR
            Project GENIE, The Cancer Genome Atlas, and the Cell Line Encyclopedia.
          </p>
        ...
        <div className="card-footer">
          ...
          <a
            href="https://academic.oup.com/bioinformatics/advance-article-pdf/doi/10.1093/bioinformatics/btab695/40532463/btab695.pdf?guestAccessKey=8b1777b2-4157-46ff-b5c2-0a69f1931cce"
            target="_blank"
            className="btn btn-light me-2"
            rel="noreferrer"
          >
          ...
          <a href="https://github.com/Caleydo/Coral" target="_blank" rel="noopener noreferrer" className="btn btn-light">
      ...
      <div className="shadow-sm card p-2 overflow-hidden">
        <div className="card-body">
          <iframe
            ...
            width="100%"
            height="100%"
            src="https://www.youtube-nocookie.com/embed/TIDUsEOsI_Y?autoplay=0"
            frameBorder="0"
